...
import { MatchDirective } from 'src/app/directives/Match.directive';
...
@NgModule({
  declarations: [ClientComponent, CompteFormComponent, RecapComponent, MatchDirective, FormatPhonePipe],
  imports: [
    CommonModule,
    FormsModule, 
    ReactiveFormsModule, 
